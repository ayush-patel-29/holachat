  ...
  return (
    <div className='h-[100vh] w-full flex flex-col justify-between'>
      ...
      <div className='text-white h-full flex flex-col text-center'>
        <h1 className='w-full text-4xl font-bold my-10'>HolaChat is Fast Conversational Intelligence</h1>
        <div className='w-full h-full flex items-center justify-center'>
          <div className='w-[70%] h-[90%] border-2 relative'>
            <div className='w-full flex flex-row py-4 items-end'>
              <textarea
              ...
              />
              <button className='w-[70px] text-white h-full flex justify-center items-center'>
